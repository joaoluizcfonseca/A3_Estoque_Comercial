...
/**
 * Sistema de controle de estoque com interface gráfica via JOptionPane.
 *
...
public class Cadastro_Produto {
    ...
    /** Quantidades em estoque de cada produto. */
    ...
    static void menuCadastro() {
        while (true) {
            ...
            switch (escolha) {
                case 0: inclusao();  break;
                case 1: alteracao(); break;
    ...
    /**
     * Cadastra um novo produto solicitando nome, unidade, preço e quantidade.
     * Impede duplicatas e valida os campos antes de salvar.
     */
    static void inclusao() {
        do {
            ...
            while (true) {
                ...
                if (nome == null) return;
                nome = nome.trim();
                if (nome.isEmpty()) { erro("Nome nao pode ser vazio!"); continue; }
                if (buscar(nome) != -1) { erro("Produto ja cadastrado!"); continue; }
                break;
            }
            ...
            while (true) {
                ...
                if (unidade.isEmpty()) { erro("Unidade nao pode ser vazia!"); continue; }
                break;
            }
            ...
            while (true) {
                ...
                try {
                    ...
                    if (preco <= 0) { erro("Preco deve ser maior que zero!"); continue; }
                    break;
                } catch (NumberFormatException e) { erro("Valor invalido!"); }
            }
            ...
            while (true) {
                ...
                try {
                    ...
                    if (quantidade < 0) { erro("Quantidade nao pode ser negativa!"); continue; }
                    break;
                } catch (NumberFormatException e) { erro("Digite um numero inteiro!"); }
            }
    ...
    /**
     * Altera unidade, preço e/ou quantidade de um produto existente.
    ...
    static void alteracao() {
        do {
            ...
            if (i == -1) { erro("Produto nao encontrado!"); continue; }
            ...
            if (entrada == null) return;
            if (!entrada.trim().isEmpty()) novaUnidade = entrada.trim().toUpperCase();
            ...
            while (true) {
                ...
                if (entrada == null) return;
                if (entrada.trim().isEmpty()) break;
                try {
                    novoPreco = Double.parseDouble(entrada.trim().replace(",", "."));
                    if (novoPreco <= 0) { erro("Preco deve ser maior que zero!"); continue; }
                    break;
                } catch (NumberFormatException e) { erro("Valor invalido!"); }
            }
            ...
            while (true) {
                ...
                try {
                    ...
                    if (novaQtd < 0) { erro("Quantidade nao pode ser negativa!"); continue; }
                    break;
                } catch (NumberFormatException e) { erro("Digite um numero inteiro!"); }
            }
    ...
    /**
     * Exibe os dados de um produto buscado pelo nome.
     */
    ...
    /**
     * Remove um produto do cadastro e compacta o vetor.
     */
    ...
    /**
     * Procura um produto pelo nome, ignorando maiúsculas e minúsculas.
     *
     * @param nome nome do produto a localizar
     * @return índice do produto, ou {@code -1} se não encontrado
     */
    ...
    /**
     * Exibe janela de entrada de texto.
     *
     * @param mensagem instrução exibida ao usuário
     * @return texto digitado, ou {@code null} se cancelado
     */
    ...
    /**
     * Exibe janela de sucesso.
     *
     * @param mensagem texto de confirmação
     */
    ...
    /**
     * Exibe janela de confirmação com "Sim" e "Não".
     *
     * @param mensagem pergunta exibida ao usuário
     * @return {@code true} se confirmado, {@code false} se negado ou fechado
     */
